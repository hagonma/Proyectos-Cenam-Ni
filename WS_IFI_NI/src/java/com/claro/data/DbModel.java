...
public class DbModel {
    ...
    private static final String DSSPNAME = "jdbc/consulta-mapa-NI";
    ...
    public String AsociarOrdenIFI(String cadena) throws Exception {
        ...
        System.out.println("AsociarOrdenIFI - Inicio proceso ");
        ...
        conexion = getConnection();
         ...
         System.out.println("AsociarOrdenIFI - cadena "+cadena);
        ...
        System.out.println("AsociarOrdenIFI - P_NOINTERACCION "+P_NOINTERACCION);
        ...
        dbManager.Conectar();
        Integer asociarFACT = dbManager.AsociarOrdenFACT(cadena);
        ...
        {*/
            try {                
                ...
                System.out.println("AsociarOrdenIFI - query "+query);
        ...
        System.out.println("AsociarOrdenIFI - respuesta "+respuesta);
